<template>
  <div>
    ...
    <div style="font-size: 20px;text-align: left">
      <i class="el-icon-document-checked">患者信息查询</i>
    </div>
    <el-divider/>
    <el-row :gutter="20">
      <el-col :span="6">
        <el-input v-model="refund_patient_search.case_number" placeholder="请输入患者病历号"></el-input>
      </el-col>
      <el-col :span="6">
        <el-input v-model="refund_patient_search.real_name" placeholder="请输入患者姓名"></el-input>
      </el-col>
      <el-col :span="2">
        <el-button @click="searchRefundByRegisterIdAndName(1)">搜索</el-button>
      </el-col>
      <el-col :span="10"></el-col>
    </el-row>
    <el-divider/>
    <div style="font-size: 20px;text-align: left">
      <i class="el-icon-document-checked">患者信息确认</i>
    </div>
    <el-divider/>
    <el-row>
    ...
    <div align="left">
      ...
      <el-table style="margin-top: 10px;width: 90%" :data="price_project_table" @selection-change="priceSelectChange">
        ...
        <el-table-column prop="item_price" label="单价" width="200"></el-table-column>
        <el-table-column prop="item_type" label="类型" width="200"></el-table-column>
        <el-table-column prop="item_format" label="规格" width="200"></el-table-column>
        <el-table-column prop="item_number" label="数量" width="180"></el-table-column>
...
export default {
  ...
  data() {
    return {
      refund_patient_search: [],
      patient: [],
      total_price:'0.00'
    }
  },
  methods: {
    searchRefundByRegisterIdAndName() {
